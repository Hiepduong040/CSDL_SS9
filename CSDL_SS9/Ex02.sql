...
from employees e group by e.manager_id;

-- 3,
select * from view_manager_summary;

-- 4,
select e.name as manager_name, vw.total_employee
from view_manager_summary vw
join employees e on vw.manager_id = e.manager_id;